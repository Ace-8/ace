...
public class WeixinConfig extends JFinalConfig {
    ...
    public void configRoute(Routes me) {
        ...
        me.add("/usehelp", UseHelpController.class);
...
//        ApiConfigKit.setAccessTokenCache(new RedisAccessTokenCache("weixin"));
        ...
        ac.setEncodingAesKey(PropKit.get("encodingAesKey", "LS7BMaPtY7KuyjphMUuFSnPL6AXUu4J2o6xSgq6nB6P"));
...
//        }
        ...
        wc.setAppId("wxde35e9f669d70985");
        wc.setAppSecret("f46f6acce57ae0150e91cf1baace670b");
